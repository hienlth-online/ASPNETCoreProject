...
namespace MyFinalProject.Entities
{
    public partial class MyStore2020Context : DbContext
    {
        public MyStore2020Context()
        {
        }

        public MyStore2020Context(DbContextOptions<MyStore2020Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=MyStore2020;Integrated Security=True");
            }
        }
